...
<Image img={require('../../static/img/graph_construction1.png')} alt="graph_construction1.png" />
...
<Image img={require('../../static/img/graph_construction2.png')} alt="graph_construction2.png" />
