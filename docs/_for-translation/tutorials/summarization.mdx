...
<Image img={require('../../static/img/summarization_use_case_1.png')} alt="Image description" />
## Concepts
...
<Image img={require('../../static/img/summarization_use_case_2.png')} alt="Image description" />
## Quickstart
...
<Image img={require('../../static/img/summarization_use_case_3.png')} alt="Image description" />
